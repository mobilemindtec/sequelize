...
class Model {
   ...
   */
   ...
   static checkPersistedProperty(obj) {
     var key, val;
     for (key in obj) {
       val = obj[key];
       console.log(key);
       ...
       if (val && typeof val === 'object') {
         ...
         if (obj && (obj[key].id > 0 || parseInt(obj[key].id) > 0)) {
           obj[Model.setIdName(key)] = obj[key].id;
           delete obj[key];
         }else{
           Model.checkPersistedProperty(obj[key])
         }
       }
     }
   };
  ...
  static create(values, options) {
    ...
    Model.checkPersistedProperty(values);
